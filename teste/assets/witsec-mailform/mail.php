...
$to = "contato@m2tel.com.br";														// To Address
$toAlt = "";												// Additional Recipients
$from = "contato@m2tel.com.br";													// From Address
$fromName = "M2 Ultra Fibra";											// From Name
...
$template = "Ola,<br><br>Você recebeu uma nova mensagem do seu site.<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Tenha um otimo dia";											// Mail Template
$autorespondSubjectPrefix = "Re:";			// Autorespond Form Subject Prefix
$autorespondSubject = "Obrigado pelo contato.";						// Autorespond Custom Subject
$autorespondTemplate = "Hi {name},<br><br>Obrigado pela sua mensagem. Retornaremos assim que possível.<br>Aqui estão as informações que você nos enviou:<br><br>{formdata}<br><br>---<br>Tenha um ótimo dia.";					// Autorespond Template
...
$smtpUsername = "contato@m2tel.com.br";									// SMTP Username
$smtpPassword = "casa1463";									// SMTP Password
